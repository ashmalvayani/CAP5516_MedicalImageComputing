...
def generate_caption(labels_path, subset):
    ...
    for index, row in tqdm(df.iterrows()):
        ...
        image_path = "/home/parthpk/NeuroChat/Brain Tumor Classification (MRI)"
        if tumor == "no":
            img_path = f"{image_path}/{subset}/notumor/{image}"
        else:
            img_path = f"{image_path}/{subset}/{tumor_type}/{image}"
        ...
        bat = {
            "custom_id": f"{row['tumor_type']}_{row['no.']}",
            "method": "POST", 
    ...
    batc_output_path = "/home/ashmal/Courses/MedImgComputing/NeuroChat/Captions/2_brain_tumor_classification/TestBatchFiles"
...
if __name__ == "__main__":
    labels_path = "/home/parthpk/NeuroChat/Brain Tumor Classification (MRI)/test_labels.csv"
    subset = "Testing"
