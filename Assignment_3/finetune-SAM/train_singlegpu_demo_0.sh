...
train_img_list="/home/ashmal/Courses/MedImgComputing/Assignment_3/finetune-SAM/datasets/NuInsSeg/a_full_set_5fold/final_files/train_fold_0.csv"
val_img_list="/home/ashmal/Courses/MedImgComputing/Assignment_3/finetune-SAM/datasets/NuInsSeg/a_full_set_5fold/final_files/val_fold_0.csv"


# Construct the checkpoint directory argument
# dir_checkpoint="${finetune_type}_${dataset_name}"

dir_checkpoint="NuInsSeg_Model_Outputs/fold_0"
